...
public class SlidingActivityHelper {
	 ...
	 *
	 * @param activity the associated fragment
	 */
	...
	/**
	 * Called to retrieve per-instance state from an fragment before being killed so that the state can be
	...
	/**
	 * Set the fragment content to an explicit view. This view is placed directly into the fragment's view
	...
	/**
	 * Gets the SlidingMenu associated with this fragment.
	 *
	 * @return the SlidingMenu associated with this fragment.
	 */
