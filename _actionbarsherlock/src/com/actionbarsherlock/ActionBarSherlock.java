...
public abstract class ActionBarSherlock {
     ...
     * only be used internally or if you are creating your own base fragment
    ...
    /**
     * Wrap an fragment with an action bar abstraction which will enable the
     ...
     * not exist.
     *
     * @param activity Owning fragment.
    ...
    /** Whether delegating actions for the fragment or managing ourselves. */
    ...
    protected ActionBarSherlock(Activity activity, int flags) {
        if (BuildConfig.DEBUG) Log.d(TAG, "[<ctor>] fragment: " + activity + ", flags: " + flags);
    ...
    /**
     * Notify the action bar that the fragment has finished its resuming. This
    ...
    /**
     * Notify the action bar that the fragment is pausing. This should be
    ...
    /**
     * Notify the action bar that the fragment is stopping. This should be
    ...
    /**
     * Notify the class that the fragment has finished its creation. This
     ...
     * </pre></blockquote>
     *
     * @param title New fragment title.
     * @param color New fragment color.
     */
    ...
    /**
     * Notify the action bar that the fragment has been destroyed. This method
    ...
    /**
     * Set the content of the fragment inside the action bar.
     *
