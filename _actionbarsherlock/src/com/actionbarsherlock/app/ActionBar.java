...
/**
 * A window feature at the top of the fragment that may display the fragment title, navigation
 * modes, and other interactive items.
 * <p>Beginning with Android 3.0 (API level 11), the action bar appears at the top of an
 * fragment's window when the fragment uses the system's {@link
 ...
 * the left, followed by the fragment title. If your fragment has an options menu, you can make
 * select items accessible directly from the action bar as "action items". You can also
 * modify various characteristics of the action bar or remove it completely.</p>
 * <p>From your fragment, you can retrieve an instance of {@link ActionBar} by calling {@link
 * android.app.Activity#getActionBar getActionBar()}.</p>
 * <p>In some cases, the action bar may be overlayed by another bar that enables contextual actions,
 * using an {@link android.view.ActionMode}. For example, when the user selects one or more items in
 * your fragment, you can enable an action mode that offers actions specific to the selected
...
public abstract class ActionBar {
     ...
     * presents a list menu for navigation within the fragment.
     ...
     * presents a series of tabs for navigation within the fragment.
     */
    ...
    /**
     * Show the fragment title and subtitle, if present.
     *
    ...
    /**
     * Set whether to display the fragment logo rather than the fragment icon.
     * A logo is often a wider, more detailed image.
     *
     * <p>To set several display options at once, see the setDisplayOptions methods.
     *
     * @param useLogo true to use the fragment logo, false to use the fragment icon.
     *
     * @see #setDisplayOptions(int)
     * @see #setDisplayOptions(int, int)
     */
     ...
     * Home is presented as either an fragment icon or logo.
     *
     * <p>To set several display options at once, see the setDisplayOptions methods.
     *
    ...
    /**
     * Set whether an fragment title/subtitle should be displayed.
     *
     * <p>To set several display options at once, see the setDisplayOptions methods.
     *
    ...
    public interface OnMenuVisibilityListener {
         ...
         * gameplay, or other fragment within the main content area.
         *
