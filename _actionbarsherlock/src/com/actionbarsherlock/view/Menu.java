...
public interface Menu {
     ...
     * action, the data that the current fragment is working with, and includes
     ...
     * appropriate Intent with the item; this means the fragment will
     ...
     * @param caller The current fragment component name as defined by
     ...
     *        requested. Entries may be null if no fragment was found for that
     *        specific action.
