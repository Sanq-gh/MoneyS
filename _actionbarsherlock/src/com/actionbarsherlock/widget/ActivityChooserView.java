...
/**
 * This class is a view for choosing an fragment for handling a given {@link Intent}.
 * <p>
 * The view is composed of two adjacent buttons:
 * <ul>
 * <li>
 * The left button is an immediate action and allows one click fragment choosing.
...
class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    /**
     * Popup window for showing the fragment overflow list.
     */
    ...
    /**
     * Flag whether a default fragment currently being selected.
     */
    ...
    /**
     * Sets the background for the button that expands the fragment
     * overflow list.
     *
     * <strong>Note:</strong> Clients would like to set this drawable
     * as a clue about the action the chosen fragment will perform. For
     * example, if a share fragment is to be chosen the drawable should
    ...
    /**
     * Sets the content description for the button that expands the fragment
     * overflow list.
     *
     * description as a clue about the action performed by the button.
     * For example, if a share fragment is to be chosen the content
     ...
     * description "share with Bluetooth" for the Bluetooth fragment.
     *
