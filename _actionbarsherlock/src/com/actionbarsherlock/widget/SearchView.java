...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    */
     ...
     * fragment or a global search provider.
     */
     ...
     * is being used to filter the contents of the current fragment and doesn't launch a separate
     * results fragment, then the submit button should be disabled.
     *
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        // if it's an action specified by the searchable fragment, launch the
    ...
    private void onVoiceClicked() {
        ...
        try {
            ...
            Log.w(LOG_TAG, "Could not find voice search fragment");
        }
    }
    ...
    private void launchIntent(Intent intent) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Failed launch fragment: " + intent, ex);
        }
    }
    ...
    private Intent createIntent(String action, Uri data, String extraData, String query,
        ...
        // as it can be destructive to the fragment stack.
        if (data != null) {
            intent.setData(data);
        }
    ...
    /**
     * Create and return an Intent that can launch the voice search fragment for web search.
     */
    ...
    /**
     * Create and return an Intent that can launch the voice search fragment, perform a specific
     * voice transcription, and forward the results to the searchable fragment.
     *
     * @param baseIntent The voice app search intent to start from
     * @return A completely-configured intent ready to send to the voice search fragment
     */
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        // because the voice search fragment will always need to insert "QUERY" into
        // it anyway.
        Bundle queryExtras = new Bundle();

        // Now build the intent to launch the voice search.  Add all necessary
        // extras to launch the voice recognizer, and then all the necessary extras
        // to forward the results to the searchable fragment
        Intent voiceIntent = new Intent(baseIntent);
