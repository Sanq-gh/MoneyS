...
//    });
    ...
    /**
     * Gets the fragment or application icon for an fragment.
     * Uses the local icon cache for fast repeated lookups.
     *
     * @param component Name of an fragment.
     * @return A drawable, or {@code null} if neither the fragment nor the application
     *         has an icon set.
     */
    private Drawable getActivityIconWithCache(ComponentName component) {
        ...
        // Then try the fragment or application icon
