        ...
        ExpandableListView.OnGroupExpandListener
{
    ...
    private void ensureList() {
        ...
        if (mAdapter != null) {
            ...
            // have our data right_black away and start with the progress indicator.
            if (mProgressContainer != null) {
...
//        super.onContentChanged();
    ...
    /**
     * Get the fragment's expandable list view widget.  This can be used to get the selection,
