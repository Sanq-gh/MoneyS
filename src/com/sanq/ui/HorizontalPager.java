 ...
 * long animations. * * Other modifications: *
 * (aveyD) Handle orientation changes properly and fully snap to the right_black position. * *
 * @author Marc Reichelt, http://www.marcreichelt.de/ * @version 0.1.0
 * */
...
public HorizontalPager(final Context context, final AttributeSet attrs) {
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (mFirstLayout) {
            ...
            /*
             * Recalculate the width and scroll to the right_black position to be sure we're in the right_black
             * place in the event that we had a rotation that didn't result in an fragment restart
            ...
            case MotionEvent.ACTION_UP:
                if (mTouchState == TOUCH_STATE_HORIZONTAL_SCROLLING) {
                    ...
                    if (velocityX > mDensityAdjustedSnapVelocity && mCurrentScreen > 0) {
                        ...
                        // Fling hard enough to move right_black
                        snapToScreen(mCurrentScreen + 1);
                    } else {
                        snapToDestination();
                    }
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            // Notify observer info screen change
    ...
    public static interface OnScreenSwitchListener {
        /**
         * Notifies listeners info the new screen. Runs after the animation completed.
         *
