...
public class DAOTransTest extends AndroidTestCase{
    ...
    public void testAdd() throws Exception {
        ...
        try {
            ...
            Account acc = new Account("З/П карта", 1500 ,"usd");
            acc = acc_dao.add(acc);
            assertNotNull(acc);
...
//if ( true) {throw new SQLiteException("test exception ...");}
            ...
            Payord pay = new Payord(acc.getId(), 1 ,1,0,"test DAO Pay" ,Calendar.getInstance().getTime(), Payord.Type.CREDIT, 100, true,false, cal.getTime(),0);
            pay = pay_dao.add(pay);
            assertNotNull(pay);
